/*
DDL idempotente — tablas base del observatorio OSD.
Orden: ejecutar antes de sql-refactor-fase1..6 (vistas y SP).
También lo ejecuta ObservatorioDbSchema al arrancar en desarrollo.
*/
SET NOCOUNT ON;
GO
